...
def raise_detection_error_message(points):
    ...
    message += "https://tryolabs.github.io/vistrack/reference/tracker/#vistrack.tracker.Detection\n"
...
Please, make sure there is an existing installation of OpenCV or install Norfair with `pip install vistrack\[video]`."""
        )
...
Please, install Norfair with `pip install vistrack\[metrics]`, or `pip install vistrack\[metrics,video]` if you also want video features."""
        )
