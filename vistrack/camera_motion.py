...
class MotionEstimator:
    ...
    transformations_getter : TransformationGetter, optional
        An instance of TransformationGetter. By default [`HomographyTransformationGetter`][vistrack.camera_motion.HomographyTransformationGetter]
    ...
    >>> from vistrack.camera_motion MotionEstimator
