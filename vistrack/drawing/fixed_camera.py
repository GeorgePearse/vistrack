...
from vistrack.camera_motion import TranslationTransformation
...
class FixedCamera:
    ...
    !!! Warning
        This only works with [`TranslationTransformation`][vistrack.camera_motion.TranslationTransformation],
        using [`HomographyTransformation`][vistrack.camera_motion.HomographyTransformation] will result in
    ...
    def adjust_frame(
        ...
        coord_transformation : TranslationTransformation
            The coordinate transformation as returned by the [`MotionEstimator`][vistrack.camera_motion.MotionEstimator]
