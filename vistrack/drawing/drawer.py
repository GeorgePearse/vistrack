...
from vistrack.drawing.color import Color, ColorType
from vistrack.tracker import Detection, TrackedObject

try:
    import cv2
except ImportError:
    from vistrack.utils import DummyOpenCVImport
...
class Drawable:
    ...
    obj : Union[Detection, TrackedObject], optional
        A [Detection][vistrack.tracker.Detection] or a [TrackedObject][vistrack.tracker.TrackedObject]
