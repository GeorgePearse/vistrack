...
class Palette:
    ...
    --------
    Change palette:
    >>> from vistrack import Palette
    >>> Palette.set("colorblind")
    >>> # or a custom palette
    >>> from vistrack import Color
    ...
    def set(cls, palette: Union[str, Iterable[ColorLike]]):
        ...
        palette : Union[str, Iterable[ColorLike]]
            ...
            - a list of ColorLike objects that can be parsed by [`parse_color`][vistrack.drawing.color.parse_color]
        """
