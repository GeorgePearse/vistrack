...
class Distance(ABC):
    ...
    def get_distances(
        ...
        ----------
        objects : Sequence[TrackedObject]
            Sequence of [TrackedObject][vistrack.tracker.TrackedObject] to be compared with potential [Detection][vistrack.tracker.Detection] or [TrackedObject][vistrack.tracker.TrackedObject]
            candidates.
        candidates : Union[List[Detection], List[TrackedObject]], optional
            List of candidates ([Detection][vistrack.tracker.Detection] or [TrackedObject][vistrack.tracker.TrackedObject]) to be compared to [TrackedObject][vistrack.tracker.TrackedObject].
...
class ScalarDistance(Distance):
    ...
    distance_function : Union[Callable[["Detection", "TrackedObject"], float], Callable[["TrackedObject", "TrackedObject"], float]]
        ...
        and the second [TrackedObject][vistrack.tracker.TrackedObject]. It has to return a `float` with the distance it calculates.
    """
