![Norfair by Tryolabs logo](https://raw.githubusercontent.com/tryolabs/vistrack/master/docs/img/banner.png)

[![Hugging Face Spaces](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Spaces-blue)](https://huggingface.co/spaces/tryolabs/vistrack-demo)
[![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/tryolabs/vistrack/blob/master/demos/colab/colab_demo.ipynb)

![PyPI - Python Versions](https://img.shields.io/pypi/pyversions/vistrack)
[![PyPI](https://img.shields.io/pypi/v/vistrack?color=green)](https://pypi.org/project/vistrack/)
[![Documentation](https://img.shields.io/badge/api-reference-blue?logo=readthedocs)](https://tryolabs.github.io/vistrack/)
[![Board](https://img.shields.io/badge/project-board-blue?logo=github)](https://github.com/tryolabs/vistrack/projects/1)
![Build status](https://github.com/tryolabs/vistrack/workflows/CI/badge.svg?branch=master)
...
| :---------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------: |
| ![Tracking players in a soccer match](https://raw.githubusercontent.com/tryolabs/vistrack/master/docs/videos/soccer.gif) | ![Tracking objects in 3D](https://raw.githubusercontent.com/tryolabs/vistrack/master/docs/videos/3d.gif) |
...
Vistrack requires Python 3.9+ (due to bayesian-filters dependency). For Python 3.8 support, use the original [Norfair](https://github.com/tryolabs/norfair) project which uses filterpy.

For the minimal version, install as:

```bash
pip install vistrack
```

To make Norfair install the dependencies to support more features, install as:

```bash
pip install vistrack[video]  # Adds several video helper features running on OpenCV
pip install vistrack[metrics]  # Supports running MOT metrics evaluation
pip install vistrack[metrics,video]  # Everything included
```
...
[Getting started guide](https://tryolabs.github.io/vistrack/latest/getting_started/).

[Official reference](https://tryolabs.github.io/vistrack/latest/reference/).
...
1. [YOLOv7](https://github.com/tryolabs/vistrack/tree/master/demos/yolov7): tracking object centroids or bounding boxes.
2. [YOLOv5](https://github.com/tryolabs/vistrack/tree/master/demos/yolov5): tracking object centroids or bounding boxes.
3. [YOLOv4](https://github.com/tryolabs/vistrack/tree/master/demos/yolov4): tracking object centroids.
4. [Detectron2](https://github.com/tryolabs/vistrack/tree/master/demos/detectron2): tracking object centroids.
5. [AlphaPose](https://github.com/tryolabs/vistrack/tree/master/demos/alphapose): tracking human keypoints (pose estimation) and inserting Norfair into a complex existing pipeline.
6. [OpenPose](https://github.com/tryolabs/vistrack/tree/master/demos/openpose): tracking human keypoints.
...
8. [YOLO-NAS](https://github.com/tryolabs/vistrack/tree/master/demos/yolo_nas): tracking object centroids or bounding boxes.

### Advanced features

1. [Speed up pose estimation by extrapolating detections](https://github.com/tryolabs/vistrack/tree/master/demos/openpose) using [OpenPose](https://github.com/CMU-Perceptual-Computing-Lab/openpose).
2. [Track both bounding boxes and human keypoints](https://github.com/tryolabs/vistrack/tree/master/demos/keypoints_bounding_boxes) (multi-class), unifying the detections from a YOLO model and OpenPose.
3. [Re-identification (ReID)](https://github.com/tryolabs/vistrack/tree/master/demos/reid) of tracked objects using appearance embeddings. This is a good starting point for scenarios with a lot of occlusion, in which the Kalman filter alone would struggle.
4. [Accurately track objects even if the camera is moving](https://github.com/tryolabs/vistrack/tree/master/demos/camera_motion), by estimating camera motion potentially accounting for pan, tilt, rotation, movement in any direction, and zoom.
5. [Track points in 3D](https://github.com/tryolabs/vistrack/tree/master/demos/3d_track), using [MediaPipe Objectron](https://google.github.io/mediapipe/solutions/objectron.html).
6. [Tracking of small objects](https://github.com/tryolabs/vistrack/tree/master/demos/sahi), using [SAHI: Slicing Aided Hyper Inference](https://github.com/obss/sahi).
...
We present a [ROS package](https://github.com/tryolabs/vistrack-ros) and a [fully functional environment](https://github.com/tryolabs/vistrack-ros-dev) running on Docker to do the first steps with this package and start your first application easier.

### Benchmarking and profiling

1. [Kalman filter and distance function profiling](https://github.com/tryolabs/vistrack/tree/master/demos/profiling) using [TRT pose estimator](https://github.com/NVIDIA-AI-IOT/trt_pose).
2. Computation of [MOT17](https://motchallenge.net/data/MOT17/) scores using [motmetrics4vistrack](https://github.com/tryolabs/vistrack/tree/master/demos/motmetrics4vistrack).

![Norfair OpenPose Demo](https://raw.githubusercontent.com/tryolabs/vistrack/master/docs/videos/openpose_skip_3_frames.gif)
...
![Tracking cars with Norfair](https://raw.githubusercontent.com/tryolabs/vistrack/master/docs/videos/traffic.gif)
...
- [**Similari**](https://github.com/insight-platform/Similari) is a high-performance Rust framework with Python bindings for building sophisticated tracking systems. It implements SORT, VisualSORT, and custom trackers with support for multi-observer tracking. Similari excels at performance-critical applications with SIMD optimizations and parallel processing, making it faster than Python-based trackers but requiring more setup compared to Vistrack's ease of integration.

## Benchmarks

[MOT17](https://motchallenge.net/data/MOT17/) and [MOT20](https://motchallenge.net/data/MOT17/) results obtained using [motmetrics4vistrack](https://github.com/tryolabs/vistrack/tree/master/demos/motmetrics4vistrack) demo script on the `train` split. We used detections obtained with [ByteTrack's](https://github.com/ifzhang/ByteTrack) YOLOX object detection model.
...
Copyright © 2022, [Tryolabs](https://tryolabs.com). Released under the [BSD 3-Clause](https://github.com/tryolabs/vistrack/blob/master/LICENSE).
