...
from vistrack.camera_motion import (
    HomographyTransformationGetter,
    MotionEstimator,
    TranslationTransformationGetter,
)

from vistrack.drawing import draw_points, draw_boxes


def yolo_detections_to_vistrack_detections(yolo_detections, track_boxes):
    vistrack_detections = []
    boxes = []
    ...
    return vistrack_detections, boxes
...
def run():
    ...
    for input_path in args.files:
        ...
        for frame in video:
            ...
            detections, boxes = yolo_detections_to_vistrack_detections(
