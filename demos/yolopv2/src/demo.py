...
from utils import (
    ...
    yolop_detections_to_vistrack_detections,
)

import vistrack
from vistrack import Tracker, Video
from vistrack.distances import iou
...
def detect():
    ...
    for frame in video:
        ...
        detections = yolop_detections_to_vistrack_detections(pred)
        tracked_objects = tracker.update(detections=detections)
        vistrack.draw_tracked_boxes(img0, tracked_objects)
