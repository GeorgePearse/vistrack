...
import vistrack
from vistrack import Detection, Paths, Tracker, Video
...
for input_path in args.files:
    ...
    for frame in video:
        ...
        detections = yolo_detections_to_vistrack_detections(
            yolo_detections, track_points=args.track_points
        )
        tracked_objects = tracker.update(detections=detections)
        if args.track_points == "centroid":
            vistrack.draw_points(frame, tracked_objects)
        elif args.track_points == "bbox":
            vistrack.draw_boxes(frame, tracked_objects)
        video.write(frame)
